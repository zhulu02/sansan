...
//    private Map<String, IgUser> userMap = new HashMap<>();
//
//
//    /**
//     * 获取来自探索页面的帖子
...
//     * @return
//     */
//    public IgUser getIgUserFromCache(String userId) {
...
//     * @param igUser
//     */
//    public void cacheIgUser(IgUser igUser) {
//        userMap.put(igUser.getUserId(), igUser);
//    }
//}
