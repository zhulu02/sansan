    ...
    <div class="row">
        ...
        <div class="col-xs-9">
            <div class="list-group div_article">
                ...
                <c:forEach items="${requestScope.igUsers}" var="igUser">
                    ...
                    <div class="list-group-item item_article">
                        <div class="row">
                            ...
                            <div class="col-xs-3 div_right_info">
                                ...
                                <c:choose>
                                    <c:when test="${igUser.headImgPath != null}">
                                        <img class="iv_article img-rounded" src=" ${igUser.headImgPath}">
                                    </c:when>
                                    <c:otherwise>
                                        <img class="iv_article img-rounded" src="/image/1.jpg">
                                    </c:otherwise>
                                </c:choose>
